...
const AchievementCard = ({ achievement, index, onClick }) => {
  ...
  return (
    <Gsap.div
      ...
      whileHover={{ y: -2 }}
      className="group relative cursor-pointer rounded-[8px] overflow-hidden border border-white/[0.08] bg-[#111111] shadow-[0_4px_14px_rgba(0,0,0,0.03)] hover:border-white/14 hover:shadow-[0_10px_28px_rgba(0,0,0,0.06)] transition-all duration-300"
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-purple-500/[0.08] via-transparent to-transparent opacity-60 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
      <div className="absolute inset-0 border border-white/[0.03] rounded-[8px] pointer-events-none" />
      ...
      <div className="relative z-10 p-6 md:p-7">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            {/* Category tag */}
            <span className="font-mono text-[8.5px] uppercase tracking-[0.18em] text-white/45 border border-white/[0.1] px-2.5 py-1 rounded-[2px] bg-black/50 shadow-[0_1px_4px_rgba(0,0,0,0.03)]">
        ...
        <div className="flex items-start justify-between gap-5">
          <div className="flex-1">
            ...
            <div className="flex items-baseline gap-3 mb-3">
              <span className="font-mono text-[10px] text-white/22 font-bold tabular-nums select-none border border-white/[0.08] px-1.5 py-0.5 rounded-[2px] leading-none">
          ...
          {/* Icon circle */}
          <div className="shrink-0 w-11 h-11 rounded-full border border-white/[0.1] bg-black/50 shadow-[0_2px_8px_rgba(0,0,0,0.04)] flex items-center justify-center group-hover:border-white/20 transition-all duration-300">
        ...
        <div className="grid lg:grid-cols-[400px_1fr] xl:grid-cols-[440px_1fr] gap-14 lg:gap-20 xl:gap-28 items-start">
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="relative aspect-[4/5] w-full rounded-[4px] overflow-hidden border border-white/[0.07] bg-black/[0.04] group">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2.5">
              <div className="bg-[#111111] border border-white/[0.08] rounded-[3px] py-3.5 px-4">
                <p className="font-mono text-[9px] uppercase tracking-[0.14em] text-white/32 mb-1.5">Status</p>
                <div className="flex items-center gap-2">
                  <span className="w-[6px] h-[6px] rounded-full bg-cyan-500 shrink-0" />
            ...
            <div className="mt-2.5 grid grid-cols-3 gap-2.5">
              {STATS.map((stat, i) => (
                <div key={i} className="bg-[#111111] border border-white/[0.08] rounded-[3px] py-4 px-3 text-center">
                  <p className="font-black text-[22px] text-white leading-none tabular-nums">{stat.value}</p>
                  <p className="font-mono text-[8px] uppercase tracking-[0.08em] text-white/32 mt-1.5 leading-tight whitespace-pre-line">{stat.label}</p>
                </div>
              ))}
            </div>
          </Gsap.div>
          ...
          <div className="flex flex-col">
            ...
            >
              <p className="font-mono text-[9.5px] md:text-[10px] uppercase tracking-[0.22em] text-white/32 mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {CAPABILITIES.map((cap, i) => (
                  <span
                    key={i}
                    className="font-mono text-[10px] md:text-[10.5px] uppercase tracking-[0.12em] font-bold text-white/75 border border-white/[0.11] px-3.5 py-[9px] rounded-[3px] hover:border-white/20 hover:text-white hover:bg-black hover:text-white transition-all duration-200 cursor-default"
                  >
                    {cap}
                  </span>
                ))}
            ...
            {achievements.length > 0 && (
              ...
              >
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <span className="font-mono text-[9px] font-bold border border-white/[0.1] bg-[#111111] px-2.5 py-1 rounded-[2px] text-white/35 tabular-nums">
