...
const GITHUB_USERNAME = 'MahateerMuhammad';
            ...
            <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
                ...
                <div className="mb-12 md:mb-16 flex flex-col lg:flex-row lg:items-end justify-between gap-8">
                    ...
                    <Gsap.a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="flex items-center gap-3 w-fit border border-cyan-400/30 text-cyan-400 px-6 py-3 hover:bg-cyan-400 hover:text-white transition-all font-mono text-sm font-bold uppercase tracking-[0.14em] md:tracking-[0.2em] group"
                    >
                        <Terminal size={16} />
                        Launch_Profile
                ...
                <div className="flex flex-col xl:flex-row gap-6 md:gap-8 w-full">
                    ...
                    >
                        ...
                        <div className="mt-8 pt-6 border-t border-white/10 flex justify-between items-center font-mono text-xs md:text-sm text-white/40">
                            ...
                            <div className="uppercase tracking-[0.12em] md:tracking-[0.16em] text-cyan-400/80 animate-pulse">
                                ONLINE
                            </div>
                        </div>
                    </Gsap.div>
