...
const TechBadge = ({ children }) => (
    <span className="px-3 py-1.5 bg-black/5 font-mono text-[10px] md:text-xs font-bold uppercase tracking-wider text-white/80">
        {children}
    </span>
);
...
function ImageCarousel() {
    ...
    return (
        <div className="relative w-full">
            ...
            <div
                className="relative bg-neutral-100 overflow-hidden aspect-video border border-white/10 rounded-[2px]"
            ...
            >
                ...
                <button
                    ...
                    className="absolute left-4 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-white/50 backdrop-blur-md rounded-full shadow-sm flex items-center justify-center hover:bg-white text-white/60 hover:text-white transition-all"
                ...
                <button
                    onClick={(e) => { e.stopPropagation(); go(1); }}
                    className="absolute right-4 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-white/50 backdrop-blur-md rounded-full shadow-sm flex items-center justify-center hover:bg-white text-white/60 hover:text-white transition-all"
            ...
            {isOpen && (
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-0 md:p-6 lg:p-10">
                    ...
                    <Gsap.div
                        ...
                        data-lenis-prevent
                        className="relative z-10 w-full h-full md:h-auto md:max-h-[90vh] max-w-6xl bg-[#0A0A0A] shadow-2xl md:rounded-lg overflow-y-auto overscroll-contain flex flex-col"
                    ...
                    >
                        ...
                        <div className="px-6 md:px-10 pt-8 pb-20 space-y-16">
                            ...
                            <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
                                ...
                                <p className="text-base md:text-lg leading-7 md:leading-8 text-white/60 max-w-2xl mx-auto">
                                ...
                                <div className="mt-10 flex flex-wrap justify-center gap-4">
                                    <a href={links.live} target="_blank" rel="noreferrer"
                                        className="bg-cyan-400 text-white px-8 py-3.5 font-bold uppercase text-xs tracking-wider hover:bg-black hover:text-white transition-all duration-300 rounded-[2px] flex items-center gap-2">
                                        <Globe size={16} /> Play Live
                                    </a>
                                    <a href={links.github} target="_blank" rel="noreferrer"
                                        className="bg-black/5 text-white px-8 py-3.5 font-bold uppercase text-xs tracking-wider border border-transparent hover:border-white/20 transition-all duration-300 rounded-[2px] flex items-center gap-2">
                            ...
                            {/* Image gallery */}
                            <div className="max-w-5xl mx-auto border border-white/5 p-2 bg-white rounded-lg shadow-sm">
                                <ImageCarousel />
                            </div>
                                        ...
                                        {highlights.map((h, i) => {
                                            ...
                                            return (
                                                <div key={i} className="group flex flex-col">
                                                    <div className="w-10 h-10 bg-black/5 rounded-full flex items-center justify-center mb-4 group-hover:bg-cyan-400 group-hover:text-white transition-colors duration-300">
                                                        <Icon size={18} strokeWidth={2} className="text-white/60 group-hover:text-white transition-colors" />
                                                    </div>
                            ...
                            {/* Footer links */}
                            <div className="max-w-5xl mx-auto border-t border-white/10 pt-12 flex flex-col md:flex-row items-center justify-between gap-6">
                                <div className="flex items-center gap-3">
                                    <span className="text-xs font-mono text-white/40 tracking-[0.12em] md:tracking-[0.16em]">TEAM:</span>
